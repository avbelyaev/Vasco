...
- исследовать подходы к компиляции функциональных языков
...
- функции в этих программах благодаря изоморфизму ... можно записать в виде обычных правил вывода
...
- находится самая вложенная функция ... и опеределяются ее свободные переменные ("f" и "a")

- рассматривается функция уровнем выше. Значение "f" найдено

- рассматривается следующая функция 
- и так далее, пока мы не будем знать значения всех переменных
...
- на выходе программа может ыть исполнена в браузере на любом устройстве
 ...
 - была выбрана модель, которая позволяет рассматривать программу как математическую функцию
